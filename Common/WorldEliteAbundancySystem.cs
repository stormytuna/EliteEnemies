...
public class WorldEliteAbundancySystem : ModSystem
{
	...
	public override void OnWorldLoad() {
		if (Main.ActiveWorldFileData.TryGetHeaderData<WorldEliteAbundancySystem>(out TagCompound data)) {
			if (data.ContainsKey("WorldEliteAbundancy")) {
				Abundancy = (WorldEliteAbundancy)data.GetByte("WorldEliteAbundancy");
			}
			else {
				Abundancy = WorldEliteAbundancy.Regular;
			}
		}
	}
	...
	public override void LoadWorldData(TagCompound tag) {
		if (tag.ContainsKey("WorldEliteAbundancy")) {
			Abundancy = (WorldEliteAbundancy)tag.GetByte("WorldEliteAbundancy");
		}
	}

	public override void NetSend(BinaryWriter writer) {
		writer.Write((byte)Abundancy);
	}

	public override void NetReceive(BinaryReader reader) {
		Abundancy = (WorldEliteAbundancy)reader.ReadByte();
	}
